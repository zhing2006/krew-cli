    ...
    fn handle_agent_event(
        ...
        match event {
            ...
            AgentEvent::Done {
                ...
                // Extract AI-to-AI mention targets before final_text is moved.
                let a2a_targets = {
