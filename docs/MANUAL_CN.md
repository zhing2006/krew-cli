...
14. [会话管理](#14-会话管理)
15. [Prompt 模式](#15-prompt-模式)
16. [项目指令 (AGENTS.md)](#16-项目指令-agentsmd)
17. [文件路径与加载优先级](#17-文件路径与加载优先级)
18. [快捷键](#18-快捷键)
19. [常见问题](#19-常见问题)
...
**保护路径免疫**：保护路径（`.git/`、`.krew/`、`.vscode/`、`.idea/`、`.claude/`、`.env`、`.bashrc` 等）始终受保护——即使在 `full-auto` 模式下，对这些路径的操作也需要确认，且不可被 allow 规则绕过。
